...
def get_args():
    ...
    parser.add_argument("--lambda_ce", default=0.01, type=float,  help="lambda for adversarial cross entropy loss in 2D classification task")
    ...
    parser.add_argument("--freq_band",  default='all', type=str, choices=['all', 'low', 'middle', 'high'], help="which frequency band should be perturbed in SAA")
