...
from attacks.saa.compression import block_splitting_3d, block_splitting_2d 
    ...
    for idx, batch_data in enumerate(loader):
        ...
        if args.adv_training_mode:
            ...
            if args.attack_name=="pgd":
                ...
                SP_Attack = saa.SAA(model, loss_fn, batch_size=images.shape[0], block_size=args.block_size, steps=args.steps, targeted=args.targeted, rho=args.rho, lambda_dice=args.lambda_dice, use_ssim_loss=args.use_ssim_loss, lambda_ssim=args.lambda_ssim, verbose=False)    
