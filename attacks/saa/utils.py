...
def ssim_loss_fn_2d_images(images, adv_images):
    # images shape:      [B,C,H,W]
    # adv_images shape:  [B,C,H,W]
    ssim_loss = 1-ssim(images, adv_images, data_range=1, nonnegative_ssim=True,size_average=True, win_size=3)
    return ssim_loss
